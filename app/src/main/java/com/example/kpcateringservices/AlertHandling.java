...
public class AlertHandling {
    ...
    public void registrationFailedDialog()
    {
        new AlertDialog.Builder(context)
                .setIcon(R.drawable.error)
                .setTitle("Error !!!")
                .setMessage("Something went wrong. Try another way. may be Account Already exist.")
                .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void numberOfPlateRequired() {
        new AlertDialog.Builder(context)
                .setIcon(R.drawable.warning)
                .setTitle("Warning !!!")
                .setMessage("Number of Plates Required to place an order.")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                ...
                .setNeutralButton("Help", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(context, "Enter Number of Plates.", Toast.LENGTH_LONG).show();
                    }
                })
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
    ...
    public void plateContentRequired() {
        new AlertDialog.Builder(context)
                .setIcon(R.drawable.warning)
                .setTitle("Warning !!!")
                .setMessage("Plate Content Required")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                ...
                .setNeutralButton("Help", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(context, "Enter Content that you want in Plate.", Toast.LENGTH_LONG).show();
                    }
                })
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
    ...
    public void invalidPhoneNumber() {
        new AlertDialog.Builder(context)
                .setIcon(R.drawable.warning)
                .setTitle("Warning !!!")
                .setMessage("Entered number is invalid.")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void details() {
        new AlertDialog.Builder(context)
                .setIcon(R.drawable.warning)
                .setTitle("Warning !!!")
                .setMessage("We will contact you regardinmg your Order")
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                ...
                .setNeutralButton("Help", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(context, "The Ower Wil Contact You. throw given number.", Toast.LENGTH_LONG).show();
                    }
                })
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    @Override
